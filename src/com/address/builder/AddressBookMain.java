	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				ContactDetails update = new ContactDetails(firstName1, lastName1, address1, city1, state1, zip1, phoneNumber1, email1);
				String s = "";
				for(AddressBook x: book) {
			...
			case 4:
				...
				List<ContactDetails> cl = new ArrayList<ContactDetails>();
